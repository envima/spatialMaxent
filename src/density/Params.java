...
public class Params extends ParamsPre {
    ...
    public void setFfme(boolean value) { setValue("ffme", value); }
    public boolean isFfme() { return getboolean("ffme"); }
