...
public class Params extends ParamsPre {
    ...
    public void setFft(boolean value) { setValue("fft", value); }
    public boolean isFft() { return getboolean("fft"); }
